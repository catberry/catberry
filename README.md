...
Catberry was developed to help create ["isomorphic/Universal" Web applications](https://github.com/catberry/catberry/blob/8.4.2/docs/index.md#isomorphicuniversal-applications).
...
* [Catberry Documentation](https://github.com/catberry/catberry/blob/8.4.2/docs/index.md)
* [Get Started Guide](https://github.com/catberry/catberry/blob/8.4.2/docs/index.md#get-started)
* [Plugins and Tools](https://github.com/catberry/catberry/blob/8.4.2/docs/index.md#plugins-and-tools)
...
* The entire architecture of the framework is built using the [Service Locator](https://github.com/catberry/catberry/blob/8.4.2/docs/index.md#service-locator) pattern – which helps to manage module dependencies and [create plugins](https://github.com/catberry/catberry/) – and [Flux](https://github.com/catberry/catberry/blob/8.4.2/docs/index.md#flux), for the data layer
* [Cat-components](https://github.com/catberry/catberry/blob/8.4.2/docs/index.md#cat-components) – similar to [web-components](http://webcomponents.org/) but organized as directories, can be rendered on the server and published/installed as NPM packages
...
[Jade](https://github.com/catberry/catberry-jade) template engines are [officially supported](https://github.com/catberry/catberry/blob/8.4.2/docs/index.md#template-engines) (and you can implement your own provider to support any other)
* Efficient DOM event listening using [event delegation](http://davidwalsh.name/event-delegate)

For more details please proceed to [Catberry Documentation](https://github.com/catberry/catberry/blob/8.4.2/docs/index.md).
...
* [Submit a PR](https://github.com/catberry/catberry/blob/8.4.2/CONTRIBUTING.md)
