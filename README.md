...
[Catberry Documentation](https://github.com/catberry/catberry/blob/1.1.1/docs/index.md).

To get started with example please proceed to 
[this document](https://github.com/catberry/catberry/blob/1.1.1/cli/README.md).
...
[Service-Module-Placeholder](https://github.com/catberry/catberry/blob/1.1.1/docs/service-module-placeholder.md) 
instead Model-View-Controller. 
SMP is the right concept for [isomorphic web-applications](https://github.com/catberry/catberry/blob/1.1.1/docs/isomorphic-applications.md).

For more details please proceed to [Catberry Documentation](https://github.com/catberry/catberry/blob/1.1.1/docs/index.md).

Also you can see [cli/templates/example](https://github.com/catberry/catberry/blob/1.1.1/cli/templates/example).
...
All changes should satisfy this [Code Style Guide](https://github.com/catberry/catberry/blob/1.1.1/docs/code-style-guide.md).
