...
* Event definition using "someHashOrDataEvent:parameter->eventName[module1,module2,module3]" syntax with list of modules that will receive event and its parameters.
