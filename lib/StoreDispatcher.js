...
class StoreDispatcher {
	...
	getStore(storeName) {
		...
		const Constructor = stores[storeName].constructor;
		constructor.prototype.$context = this._getStoreContext(storeName);
		this._storeInstances[storeName] = new Constructor(this._serviceLocator);
		this._storeInstances[storeName].$context = constructor.prototype.$context;
	...
	/**
	 * Returns an error about a not found store.
	...
	/**
	 * Returns an error about uninitialized state.
	 * @return {Promise<Error>} The promise for the error.
	 */
	_errorState() {
